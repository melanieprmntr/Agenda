...
public class ContactServiceSansSingleton {
	...
	public static void save(HibernateConfiguration hibernateConfiguration, ContactDto contact) {
		if (contact.getId() == null) {
			insert(hibernateConfiguration, contact);
		} else {
			update(hibernateConfiguration, contact);
		}
	}

	private static void insert(HibernateConfiguration hibernateConfiguration, ContactDto contact) {
		...
		try {
			session = hibernateConfiguration.getFactory().openSession();
	...
	private static void update(HibernateConfiguration hibernateConfiguration, ContactDto contact) {
		Session session = null;
		Transaction transaction = null;
		try {
			session = hibernateConfiguration.getFactory().openSession();
